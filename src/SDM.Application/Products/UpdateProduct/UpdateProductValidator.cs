...
/// <summary>
/// FluentValidation validator for <see cref="UpdateProductCommand"/>.
/// Enforces all business input rules before the command reaches <see cref="UpdateProductHandler"/>.
/// Invoked automatically by <c>ValidationBehavior</c> in the MediatR pipeline.
/// </summary>
public sealed class UpdateProductValidator : AbstractValidator<UpdateProductCommand>
{
    /// <summary>Initializes a new instance of <see cref="UpdateProductValidator"/> and defines all rules.</summary>
