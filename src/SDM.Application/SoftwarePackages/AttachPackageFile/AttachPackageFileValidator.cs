...
/// <summary>
/// Validates <see cref="AttachPackageFileCommand"/>.
/// </summary>
public sealed class AttachPackageFileValidator : AbstractValidator<AttachPackageFileCommand>
{
    /// <summary>Initializes a new instance of <see cref="AttachPackageFileValidator"/>.</summary>
    public AttachPackageFileValidator()
    {
        ...
        RuleFor(x => x.SHA256)
            ...
            .Matches("^[0-9a-fA-F]{64}$").WithMessage("SHA-256 must be a valid lowercase hex string.");
