...
/// <summary>
/// Command to register a new file reference against an existing software package.
/// Physical upload is handled before calling this command; only metadata is accepted here.
/// </summary>
public sealed class AttachPackageFileCommand : ICommand<AttachPackageFileResponse>
{
    /// <summary>Gets the parent package identifier. Supplied by the route.</summary>
