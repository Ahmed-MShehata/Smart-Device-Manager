...
/// <summary>
/// FluentValidation validator for <see cref="CreateSoftwarePackageCommand"/>.
...
{
    /// <summary>Initializes a new instance of <see cref="CreateSoftwarePackageValidator"/>.</summary>
