...
/// <summary>
/// Full order detail DTO, including customer contact info and all line items.
...
public sealed class GetOrderResponse
{
    ...
    /// <summary>Gets the customer's WhatsApp number. Null if not provided.</summary>
    public string? CustomerWhatsApp { get; init; }

    /// <summary>Gets the customer's governorate.</summary>
...
/// Price reflects the snapshot captured at order creation time.
/// </summary>
public sealed class OrderItemResponse
{
    ...
    /// <summary>Gets the display name of the product at query time.</summary>
    public string ProductName { get; init; } = string.Empty;

    /// <summary>Gets the product image URL. Null if not set.</summary>
    public string? ProductImageUrl { get; init; }

    /// <summary>Gets the number of units ordered.</summary>
    public int Quantity { get; init; }

    /// <summary>Gets the unit price snapshot at order creation time.</summary>
